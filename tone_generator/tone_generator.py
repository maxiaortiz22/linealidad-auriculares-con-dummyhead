...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_tone_generator')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_tone_generator')
    _tone_generator = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_tone_generator', [dirname(__file__)])
        except ImportError:
            import _tone_generator
            return _tone_generator
        try:
            _mod = imp.load_module('_tone_generator', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
...
class ToneGenerator(_object):
    ...
    def __init__(self, freq, amp, sr):
        this = _tone_generator.new_ToneGenerator(freq, amp, sr)
        try:
